<div id='toolbar'>
	<div id='toolbaralignment'>
		<div style='float:left;padding:0px;height:100%'>
				<a href='http://www.relatablez.com/kartik/'><img style='vertical-align:middle;' height='35' src='http://www.relatablez.com/kartik/logotextwhite.png' alt='Relatablez / Am I The Only One?' title='Relatablez / Am I The Only One?'></a>								
		</div>		
		<div  class='account-buttons'>
			<?php
				if($_SESSION["username"] != null)
				{
					echo "<button class='toolbar notifs'>Notifs</button>";
						
					echo "<button class='toolbar profile'>kartik</button>\r\n";
				}
				else
				{
